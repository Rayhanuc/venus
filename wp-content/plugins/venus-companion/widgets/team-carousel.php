...
class Team_Carousel extends Widget_Base {
    ...
    protected function render() {
        ...
        echo '<div class="owl-carousel owl-theme dot-style-2 nav-inside nav-circle-solid-light px-md-0 px-3"
            data-items="[4,2]" data-margin="30" data-autoplay="true" data-center="true" data-loop="true" data-nav="true"
            data-dots="true">';
