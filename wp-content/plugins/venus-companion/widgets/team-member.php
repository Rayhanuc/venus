...
class Team_Member extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'dribbble',
			[
				'label' => __( 'Dribbble', 'venus-companion' ),
				'type' => Controls_Manager::TEXT,
			]
		);
        ...
        $this->add_control(
            'overlay',
            [
                'label' => __( 'Overylay Color', 'venus-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
					'{{WRAPPER}} .team-hover:hover .team-info' => 'background: {{VALUE}}',
				],
            ]
        );
        ...
        <div class="team-hover card border-0 mb-4">
            ...
            <div class="team-info">
                ...
                <div class="team-social-links">
                    ...
                    <a href="<?php echo esc_url($settings['dribbble']);?>"><i class="fab fa-dribbble"></i></a>
                </div>
            </div>
        </div>
